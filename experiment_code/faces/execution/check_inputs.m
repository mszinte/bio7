...
if subject_MRI == 1
    ...
    if exist((fullfile('data',['sub-00' int2str(subject_no) '_task-emotion_run-00' int2str(subject_run) '.mat'])),'file')
    ...
    if exist((fullfile('data',['sub-00' int2str(subject_no) '_task-emotion_run-00' int2str(subject_run) '_test.mat'])),'file')
...
if subject_MRI == 0 %test 
    ...
    if exist((fullfile('data',['sub-00' int2str(subject_no) '_task-emotion_data_test.csv'])),'file')
        ...
        if subject_run == 1
            ...
            if create == 0
                ...
                experiment1_task_data = readtable(fullfile('data',['sub-00' int2str(subject_no) '_task-emotion_data_test.csv']));
                experiment1_rest_data = readtable(fullfile('data',['sub-00' int2str(subject_no) '_task-emotion_rest_data_test.csv']));
            end
    ...
    if exist((fullfile('data',['sub-00' int2str(subject_no) '_task-emotion_data.csv'])),'file')
        ...
        if subject_run == 1
            ...
            if create == 0
                ...
                experiment1_task_data = readtable(fullfile('data',['sub-00' int2str(subject_no) '_task-emotion_data.csv']));
                experiment1_rest_data = readtable(fullfile('data',['sub-00' int2str(subject_no) '_task-emotion_rest_data.csv']));
            end
