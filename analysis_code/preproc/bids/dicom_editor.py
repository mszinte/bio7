...
-----------------------------------------------------------------------------------------
Goal of the script:
Subject 8762 was run as 1 MRI session, not 2.
Also had dicom screenshot niftiis that block dicom2tar.py 01_5005_*
Before running dicom2tar.py, run/ran this code to clean and reformat dicoms  
-----------------------------------------------------------------------------------------
Input(s):
...
>> python3 bids/dicom_editor.py [meso_proj_dir] [meso_home_sw_dir] [subject_number]
-----------------------------------------------------------------------------------------

01_0001_aahead-scout-32ch-head-coil                     
01_0039_aahead-scout-32ch-head-coil
01_5001_mocoseries
