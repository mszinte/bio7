...
#----------------------
if task == "faces":
    R_code_events = "{}/projects/{}/analysis_code/preproc/functional/events_faces.R".format(meso_home_dir, projname)
elif task == "faceloc":
    R_code_events = "{}/projects/{}/analysis_code/preproc/functional/events_faceloc.R".format(meso_home_dir, projname)
else:
    pass
